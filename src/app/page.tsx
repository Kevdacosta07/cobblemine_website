...
function Brand() {return <a className="brand" href="#accueil" aria-label="Cobblemine, accueil"><Image src="/cobblemine-logo-approved.png" alt="Cobblemine" width={150} height={100} /></a>;}
