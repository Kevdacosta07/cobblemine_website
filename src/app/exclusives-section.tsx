    ...
    <div className="exclusives-inner">
      ...
      <div className="exclusive-solo-caption">
        ...
        <div className="exclusive-variant-switch" role="group" aria-label={`Apparence de ${item.name}`}>
          ...
          <button type="button" disabled={phase !== "idle"} aria-pressed={shiny} onClick={() => setShiny(true)}><svg aria-hidden="true" width="14" height="14" viewBox="0 0 20 20" fill="none"><path d="m10 2 2.2 5.8L18 10l-5.8 2.2L10 18l-2.2-5.8L2 10l5.8-2.2L10 2Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/></svg>Shiny</button>
        </div>
