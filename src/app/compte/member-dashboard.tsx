  ...
  return <div className="member-inner">
    ...
    <div className="member-layout">
      ...
      <div className="member-content">
        ...
        {view==='overview'&&<>
          <section className="member-banner"><Image src="/member-assets/launcher-landscape.png" alt="" fill sizes="(max-width: 760px) 100vw, 850px" priority/><div className="member-banner-copy"><h2>Prêt pour votre prochaine aventure ?</h2><p>Installez le launcher pour préparer votre arrivée.</p><div className="member-banner-actions"><Link href="/#rejoindre" className="member-primary"><Icon name="download"/>Télécharger le launcher</Link><span>Ouverture du serveur à venir</span></div></div></section>
